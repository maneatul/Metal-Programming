...
class Renderer: NSObject, MTKViewDelegate {
    ...
    init(_ parent: ContentView) {
        ...
        mesh = ObjMesh(metalDevice: metalDevice, allocator: allocator, filename: "cube")
    ...
    func draw(in view: MTKView) {
        ...
        renderEncoder?.setVertexBuffer(mesh.metalMesh.vertexBuffers.first?.buffer, offset: 0, index: 0)
